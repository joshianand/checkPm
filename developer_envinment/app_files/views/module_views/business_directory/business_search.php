        ...
        <div class="span12">
            <div class="portlet box blue">
                ...
                <div class="portlet-body">
                    <a href="#options" role="button" class="btn btn-primary blue" data-toggle="modal" style="margin-bottom: 5px;"><i class="icon-search"></i> Search</a>
                    <button href="#" onclick="initializeSearchList('', '');" role="button" class="btn btn-primary blue" style="margin-bottom: 5px;">Reset Search</button>
